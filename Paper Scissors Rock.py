...
def game_start():
    ...
    #Documentation on dictionaries: https://www.w3schools.com/python/python_dictionaries.asp
    #Documentation on lists: https://www.w3schools.com/python/python_lists.asp
    ...
    while(retry != False):
        ...
        #user_input variable.
        #Documentation on inputs: https://www.w3schools.com/python/ref_func_input.asp
        user_input = input("\n\n(1) Paper \n(2) Scissors \n(3) Rock\n")
        ...
        #Documentation on capitalize(): https://www.w3schools.com/python/ref_string_capitalize.asp
        ...
        #Documention on access dictionary values: https://www.w3schools.com/python/python_dictionaries_access.asp
    ...
    #Once the game is properly ended the console print out a input displaying thank you for playing and propmt the player to press Enter to quit. This is an input so that the window
